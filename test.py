...
from humanliker.modeling.test_time_augmentation import GeneralizedRCNNWithTTA
from humanliker.config import add_humanliker_config
from humanliker.data.custom_build_augmentation import build_custom_augmentation
...
def do_test(cfg, model):
    ...
    for dataset_name in cfg.DATASETS.TEST:
        mapper = None if cfg.INPUT.TEST_INPUT_TYPE == 'default' else \
            DatasetMapper(
                cfg, False, augmentations=build_custom_augmentation_test(cfg, False))
...
def do_train(cfg, model, resume=False):
    ...
    if cfg.DATALOADER.SAMPLER_TRAIN in ['TrainingSampler', 'RepeatFactorTrainingSampler']:
        ...
        from humanliker.data.custom_dataset_dataloader import  build_custom_train_loader
